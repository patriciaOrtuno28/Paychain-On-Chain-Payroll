...
export interface PayrollConfidentialWrapperInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PayrollConfidentialWrapper extends BaseContract {
  connect(runner?: ContractRunner | null): PayrollConfidentialWrapper;
  waitForDeployment(): Promise<this>;

  interface: PayrollConfidentialWrapperInterface;
